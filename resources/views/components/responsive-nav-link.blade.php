...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-accent text-start text-base font-medium text-accent bg-accent/5 focus:outline-none focus:text-primary focus:bg-accent/10 focus:border-accent transition duration-150 ease-in-out'
